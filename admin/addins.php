          ...
          <div class="col-xl-7 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              <div class="card-header text-center pt-4">
                <h5>Instructor Registration Form</h5>
              </div>  
              <div  class="card-body" >
                <form  role="form text-left" action="inspro.php" method="post">
                  <div class="mb-3">
                  ...
                  <p class="text-sm mt-3 mb-0"> <a href="instructor.php" class="text-primary font-weight-bolder">Back</a></p>
                </form>
              </div>
            </div>
          </div>
