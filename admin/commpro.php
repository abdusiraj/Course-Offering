...
$sql = "INSERT INTO `committee`(`fname`, `mname`, `lname`, `address`, `email`, `age`, `sex`, `uname`, `pass`) VALUES ('".$fname."','".$mname."','".$lname."','".$addres."','".$email."','".$age."','".$sex."','".$uname."','".$pass."')";
$run = $con->query($sql);
...
//header("Location:admin/index.php");
                                    ...
                                    echo '</script>';
                                    echo '<meta http-equiv="refresh" content="0;url=central committee.php" />';
                            }
  ...
  echo '<script language="javascript">';
                                    ...
                                    echo '</script>';
                                    echo '<meta http-equiv="refresh" content="0;url=addchair.php" />';
}
?>