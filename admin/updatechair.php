...
<?php 
  ...
  $selExmne = $con->query("SELECT * FROM chair WHERE cha_id='$id' ")->fetch_ASSOC();
...
<form method="post" action="chairupdatepro.php">
     ...
     <div class="mb-3">
                            ...
                            <select id="language" name="chairtype" class="select2 form-select">
                              <option value="<?php echo $selExmne['ch_type']; ?>"><?php echo $selExmne['ch_type']; ?></option>
